...
all_file_l=["o_f_"+str(i)+".txt" for i in range (1,no_files+1)]
shuffle(all_file_l)
...
print("\nStarting Optimiser ")
opt_l=[round(i*0.1,1) for i in range(1,10)]
...
for opt_var in opt_l:
    ...
    print("Running With ",opt_var," ratio")
    pos_in=5
    neg_in=5
    step=1.0
    ...
    test_n_l_1=all_test_n_l[:round(opt_var*42)]        #for weight opt
    test_n_l_2=all_test_n_l[round(opt_var*42):]        #for actual testing
    ...
    final_opt.append([opt_var,(yy+nn)*100/len(final_test),pow_wt,neg_wt])
