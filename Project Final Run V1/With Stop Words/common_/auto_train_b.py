...
file_f=["o_f_"+str(i)+".txt" for i in range (1,157)]
file_b=["o_b_"+str(i)+".txt" for i in range (1,28)]
file_s=["o_s_"+str(i)+".txt" for i in range (1,151)]
file_l=file_f+file_b+file_s
